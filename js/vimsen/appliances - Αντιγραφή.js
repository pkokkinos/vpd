    ...
    var jqxhr = $.getJSON(vgwFile, function(data) {
        ...
        .success(function(data) {
            ...
            $.each(data, function(index, element) {
                ...
                // UPDATE: exception not neede anymore since hedno guys fixed the topic format.
            ...
            if (element.prosumption.toUpperCase() === "ACTIVEPOWER") {
                ...
                if (element.type.toUpperCase() === "BUILDINGITEMSWITCH") {
                    ...
                    ali.innerHTML = '<div  class="dash-widget-item switchApplianceItem"> <div class="switchHeader"> ' +
                        ...
                        '<input id="ts-' + macaddress + applianceName + '" type="checkbox" hidden="hidden" class="switchON_OFF" item="' + element.type + '" dr="' + drUrl + '" ip="' + ipaddress + '"> <label for="ts-' + macaddress + applianceName + '" class="ts-helper"></label> </div> </div> </div>' +
                        ...
                        ' <small class="f-12">STATE</small> <h3 id= "' + macaddress + applianceName + '_state" class="p-5 m-0 f-400 c-white state_value" topicid="' + topicON_OFF + '">' + element.state + '</h3> </div> <div class="col-xs-6"> ' +
                        '</div> </div> </div> </div>';
                ...
                // if (macaddress === "b827eb4c14af" && applianceName ==="FibaroPlug_2") {
                //     aN = "FibaroPlug_61"
                // } else {
                //     aN = applianceName
                // }
                ...
                ali.innerHTML = '<div  class="dash-widget-item consumptionApplianceItem"> <div class="consumptionHeader"> ' +
                    '<div class="dash-widget-header"> <div class="dash-widget-title  f-14 f-500"> ' + applianceName + ' <br/> <small>' + vgwname + '</small> </div>' +
                    ' <div class="pull-right m-t-15 m-r-5 m-b-15"> <div class="toggle-switch" data-ts-color="red"> ' +
                    '<input id="ts-' + macaddress + applianceName + '" type="checkbox" hidden="hidden" class="switchON_OFF" item="' + element.type + '" dr="' + drUrl + '" ip="' + ipaddress + '" topicid="' + topicON_OFF + '"> <label for="ts-' + macaddress + applianceName + '" class="ts-helper"></label> </div> </div> </div>' +
                    ' <div class="clearfix"></div> </div> <div class="bgm-lime p-20 text-right"> <div class="row"> ' +
                    ...
                    ' <small class="f-12">STATE</small> <h3 id= "' + macaddress + applianceName  + '_state" topicid="' + topicON_OFF + '" class="p-5 m-0 f-400 c-white state_value">' + element.state + '</h3> </div> <div class="col-xs-6"> ' +
